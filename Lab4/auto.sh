...
sudo apt update
sudo apt install build-essential flex bison ruby libgl1-mesa-dev libglib2.0-dev libncurses5-dev libxcursor-dev libxrandr-dev libxinerama-dev libexpat1-dev default-jdk libelf-dev ccache libssl-dev genext2fs liblz4-tool curl libstdc++-11-dev
